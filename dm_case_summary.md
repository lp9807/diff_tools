...
| Missing elements     | 78              | 78                  | Graphics elements missing in Graphite results<br>- HO Graphite vs Android Graphite: 7x out of 74 cases with noticeable difference |
...
These cases are rendered with graphics elements missing in Graphite comparing to Ganesh. Classify them based on draw primitive types.
...
| drawEdgeAAQuad + large matrix      | compositor_quads_filter                                                                                      | parameters:  drawEdgeAAQuad(required by maskfilter ) + perspective matrix<br>- graphite: texture position shift                                                                      |                       |                  |
...
|                                    | drawable                                                                                                     | - graphite: `graphite::device::drawDrawable` is empty                                                                                                                                |                       |                  |
...
| Large rectangle size    | path_huge_aa                                                                                         | draw path from big `SkPath::RRect` = disappear                                                                           |                       |
...
| TBC                              | smallcircles                                                                               | drawArc + translate + image blending ??                                                                                                                        |
